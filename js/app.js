...
var typed = new Typed(".typing", {
  strings: ["Web Designer", "IT Support", "Web Develper"],
  typeSpeed: 100,
  backSpeed: 60,
  loop: true,
});
...
window.addEventListener("scroll", function (event) {
  ...
  document.querySelector(".nama").style.transform =
    "rotate(-" + scroll / 10 + "deg)";
  var warna = (document.querySelector(".nama").style.filter =
    "hue-rotate(-" + scroll / 5 + "deg)");
